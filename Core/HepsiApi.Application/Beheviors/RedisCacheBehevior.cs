...
{
    public class RedisCacheBehevior<IReguest, TResponse> : IPipelineBehavior<IReguest, TResponse>
    {
        ...
        public async Task<TResponse> Handle(IReguest request, RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
        {
